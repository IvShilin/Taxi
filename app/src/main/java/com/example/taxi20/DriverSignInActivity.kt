...
class DriverSignInActivity : AppCompatActivity(), ValidationData {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_driver_sign_in)

        mailTextInputEditText = findViewById(R.id.driverSignInEMailTextInputEditText)

        nameTextInputEditText = findViewById(R.id.driverSignInNameTextInputEditText)

        passwordTextInputLayout = findViewById(R.id.driverSignInPasswordTextInputLayout)
        passwordTextInputEditText = findViewById(R.id.driverSignInPasswordTextInputEditText)

        confirmPasswordTextInputLayout = findViewById(R.id.driverSignInConfirmPasswordTextInputLayout)
        confirmPasswordTextInputEditText = findViewById(R.id.driverSignInConfirmPasswordTextEditText)
    }



    fun driverConfirmSignIn(view: android.view.View) {
