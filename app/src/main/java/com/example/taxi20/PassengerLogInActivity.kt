...
class PassengerLogInActivity : AppCompatActivity(), ValidationData {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mailTextInputEditText = findViewById(R.id.passengerLogInEMailTextInputEditText)
        passwordTextInputEditText = findViewById(R.id.passengerLogInPasswordTextInputEditText)
    }

    fun goToSignInPassenger(view: android.view.View) {
       startActivity(Intent(this, PassengerSignInActivity::class.java))
    }

    fun passengerConfirmLogIn(view: android.view.View) {
